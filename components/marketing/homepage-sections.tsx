          ...
          <div className="md:col-span-2 glass-strong p-8 rounded-2xl" ref={counter1.ref}>
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-sm text-gray-400 mt-2">Assessments completed across 40+ countries</p>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          {testimonials.map((t, i) => (
            <div key={t.name} className={`reveal stagger-${i + 1} glass-strong p-6 rounded-2xl`}>
