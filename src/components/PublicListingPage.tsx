    ...
    <div className="max-w-5xl mx-auto px-5 sm:px-6 py-14">
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-8">
        ...
        <select
          ...
          className="border border-gray-200 rounded-md px-3 py-2 text-sm text-gray-600 focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-400"
        >
