    ...
    <div className="space-y-5">
      ...
      >
        ...
        <button
          ...
          className="mt-4 text-xs text-orange-400 hover:text-orange-300 font-medium flex items-center gap-1"
        >
      ...
      >
        <div className="relative">
          <button
            onClick={handleShare}
            className="bg-orange-500 hover:bg-orange-400 text-white px-6 py-2.5 rounded-md text-sm font-medium transition-colors flex items-center gap-2"
          >
