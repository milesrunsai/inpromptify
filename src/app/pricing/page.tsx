  ...
  return (
    <>
      ...
      <main className="bg-[#111118] min-h-screen">
        <div className="max-w-5xl mx-auto px-5 sm:px-6 lg:px-8 pt-28 pb-16 md:pb-20">
          <div className="max-w-2xl mb-12">
            <span className="section-label">[ Pricing ]</span>
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-3 mt-2">Pricing</h1>
          ...
          <div className="flex items-center gap-3 mb-10">
            ...
            <button
              ...
              className={`relative w-10 h-5 rounded-full transition-colors ${annual ? "bg-gradient-to-r from-orange-500 to-amber-500" : "bg-white/[0.12]"}`}
            ...
            <span className={`text-sm font-medium ${annual ? "text-white" : "text-gray-500"}`}>
              Annual
              <span className="ml-1.5 text-xs text-orange-400 font-medium">Save 20%</span>
            </span>
          </div>
            ...
            {plans.map((plan) => (
              <div
                ...
                className={`rounded-lg p-6 flex flex-col ${
                  plan.highlight
                    ? "bg-orange-500/[0.08] border-2 border-orange-500/30"
                ...
                <ul className="space-y-2.5 mb-6 flex-1">
                  {plan.features.map((feature) => (
                    <li key={feature} className="flex items-start gap-2 text-sm text-gray-400">
                      <svg className="w-4 h-4 mt-0.5 shrink-0 text-orange-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
          ...
          <div className="mt-20 mb-20">
            <div className="text-center mb-10">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-white tracking-tight mb-3 mt-2">
            ...
            <div className="max-w-md mx-auto mb-10">
              ...
              <input
                ...
                className="w-full h-1.5 bg-white/[0.08] rounded-full appearance-none cursor-pointer accent-orange-500"
              />
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
              {/* InpromptiFy Side */}
              <div className="bg-orange-500/[0.06] border-2 border-orange-500/30 rounded-xl p-7">
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-orange-400 text-[12px]">Included</span>
                  </div>
                  <div className="flex justify-between text-sm">
              ...
              <div className="bg-white/[0.03] border border-white/[0.06] rounded-xl p-7">
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-orange-600/40 text-[12px]">Not available</span>
                  </div>
                  <div className="flex justify-between text-sm">
            ...
            {(() => {
              ...
              return savings > 0 ? (
                <div className="max-w-4xl mx-auto mt-6">
                  <div className="bg-orange-500/[0.06] border border-orange-500/20 rounded-xl p-5 flex items-center justify-between">
                    ...
                    <Link
                      href="/signup"
                      className="shrink-0 bg-gradient-to-r from-orange-500 to-amber-500 hover:opacity-90 text-white text-sm font-medium px-5 py-2 rounded-md transition-colors"
                    >
                      Get Started
                    </Link>
                  </div>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-white/[0.06]">
                      ...
                      <th className="text-center text-[11px] text-orange-400 uppercase tracking-wider px-5 py-3">
                  ...
                  <tbody>
                    {[
                      ...
                      const cell = (val: boolean | string) => {
                        if (val === true) return <span className="text-orange-400">&#10003;</span>;
                        if (val === "partial") return <span className="text-orange-400/60 text-[11px]">Partial</span>;
          ...
          <div className="max-w-2xl mt-20">
            ...
            <h2 className="text-xl font-bold text-white mb-6 mt-2">Common questions</h2>
