      ...
      <div className="max-w-4xl">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Paste a conversation with ChatGPT, Claude, or any AI to get instant feedback on your prompting technique.
          </p>
        </div>
        ...
        <div className="max-w-2xl">
          <div className="space-y-6">
            ...
            <button
              ...
              className="px-8 py-3.5 rounded-xl bg-orange-500 text-white font-semibold hover:bg-orange-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
      ...
      <div className="max-w-4xl">
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">
                Your conversation has been analyzed and scored
              </p>
            </div>
            <button
              onClick={handleReset}
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-200 text-sm font-medium text-gray-700 hover:border-gray-300 transition-colors"
            >
        ...
        <div className="bg-gray-50 rounded-xl p-6 mb-8">
          <div className="flex items-center gap-6">
            <div className="flex items-center justify-center w-20 h-20 rounded-full bg-orange-50 border-4 border-orange-500/20">
              <span className="text-2xl font-bold text-orange-500">{results.overallScore}</span>
            </div>
            <div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          {/* Individual Prompts */}
          <div className="space-y-6">
            <h3 className="text-lg font-semibold text-gray-900">Your Prompts</h3>
          ...
          {/* Patterns to Improve */}
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-6">Top 3 Patterns to Improve</h3>
