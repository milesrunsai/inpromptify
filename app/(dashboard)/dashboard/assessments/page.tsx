      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        ...
        <div className="relative">
          <button
            ...
            className="flex h-8 items-center gap-2 rounded-lg border border-white/[0.08] bg-white/[0.03] px-3 text-sm text-white/70 transition-colors hover:bg-white/[0.06]"
          >
            <span>{statusFilter === "All" ? "All Statuses" : statusLabel[statusFilter]}</span>
            <ChevronDown className="size-3.5" />
          </button>
          {showStatusDropdown && (
            <div className="absolute left-0 top-full z-40 mt-1 w-44 rounded-lg border border-white/[0.08] bg-[#141414] py-1 shadow-xl">
              {STATUS_OPTIONS.map((s) => (
                <button
                  ...
                  className={cn(
                    "flex w-full items-center px-3 py-1.5 text-left text-sm transition-colors hover:bg-white/[0.06]",
                    statusFilter === s
                      ? "text-orange-400"
                      : "text-white/70"
                  )}
        ...
        <div className="relative flex-1 sm:max-w-xs">
          ...
          <Input
            ...
            className="h-8 border-white/[0.08] bg-white/[0.03] pl-8 text-white placeholder:text-white/30"
          />
        </div>
      </div>
          ...
          {loading ? (
            ...
            <div className="space-y-3">
              {Array.from({ length: 5 }).map((_, i) => (
                <div
                  key={i}
                  className="flex items-center gap-4 rounded-lg border border-white/[0.05] bg-white/[0.02] p-4"
                >
                  ...
                  <div className="ml-auto h-4 w-24 animate-pulse rounded bg-white/[0.06]" />
                </div>
              ))}
            </div>
            ...
            <div className="flex flex-col items-center justify-center py-16 text-center">
              <div className="mb-4 flex size-16 items-center justify-center rounded-full bg-white/[0.05]">
                <Send className="size-7 text-white/30" />
              </div>
            ...
            <div className="space-y-2">
              {/* Header row */}
              <div className="hidden items-center gap-4 px-4 py-2 text-xs font-medium uppercase tracking-wider text-white/40 sm:grid sm:grid-cols-[1fr_100px_80px_120px_60px]">
                <span>Candidate</span>
                <span>Status</span>
                <span>Score</span>
                <span>Created</span>
              ...
              {assessments.map((a) => (
                <div key={a.id}>
                  <div
                    className={cn(
                      "grid items-center gap-4 rounded-lg border border-white/[0.08] bg-white/[0.03] p-4 transition-colors hover:bg-white/[0.05] sm:grid-cols-[1fr_100px_80px_120px_60px]",
                  ...
                  {/* Expanded detail */}
                  {expandedId === a.id && (
                    <div className="rounded-b-lg border border-t-0 border-white/[0.08] bg-white/[0.02] p-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              className="border-white/[0.08] bg-white/[0.03] text-white/70 hover:bg-white/[0.06] hover:text-white disabled:opacity-30"
            >
