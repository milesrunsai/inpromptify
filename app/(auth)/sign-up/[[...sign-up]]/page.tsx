...
export default function SignUpPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background/95 backdrop-blur-sm px-4 py-8">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white border border-gray-200 shadow-2xl shadow-black/20 rounded-2xl p-8">
          ...
          {/* OAuth buttons (greyed out) */}
          <div className="space-y-2 mb-6">
            <button
              disabled
              className="w-full flex items-center justify-center gap-3 rounded-lg border border-gray-200 bg-gray-50 px-4 py-2.5 text-sm text-gray-400 cursor-not-allowed relative group"
              title="Coming soon"
            >
              ...
              <span className="absolute right-3 text-[10px] text-gray-400 bg-gray-100 px-1.5 py-0.5 rounded">
                Soon
              </span>
            </button>
            <button
              ...
              title="Coming soon"
            >
              <svg className="size-5" viewBox="0 0 24 24" fill="#a0a0a0">
