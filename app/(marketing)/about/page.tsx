  ...
  return (
    <div className="min-h-screen pt-24 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        {/* How We Connect */}
        <div className="mt-24 bg-white/[0.03] border border-white/[0.08] rounded-3xl p-8 sm:p-12 -mx-4 sm:-mx-6 px-4 sm:px-6">
          <h2 className="text-2xl sm:text-3xl font-bold text-white text-center">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-12">
            {[
              ...
              <div
                key={item.title}
                className="bg-white/[0.03] border border-white/[0.08] rounded-2xl p-6 hover:border-orange-500/10 transition-all duration-300"
              >
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative aspect-[3/4] max-w-sm mx-auto lg:mx-0 rounded-2xl overflow-hidden">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <p className="text-sm text-white/60">Founder and CEO</p>
